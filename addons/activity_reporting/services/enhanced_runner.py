        ...
        try:
            response = requests.post(
                ...
                data={
                    ...
                    'stream': 'true'  # Changed to string 'true'
                },
                timeout=60,
...
def main():
    ...
    if agent_type == "orchestrator":
        ...
        if agent_type == "employee":
            def search_employees(department: str = None, name: str = None) -> str:
                """
            ...
            tools = [search_employees, list_departments, get_employee_details]
